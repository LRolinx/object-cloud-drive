...
import { ref, getCurrentInstance, onBeforeMount, Ref } from 'vue'
import { useUserStore } from '@/store/models/user'
import lVideo from '@/components/lVideo.vue'

const isShow = ref(false)
const videoList: Ref<string[]> = ref([])
const lsSrc = ref('')
...
videoList.value.push('m2+c7R+kU2IF4Kn8v9c/kCJqZGx5f2Ioj3XOX6HxXjTg7X1gXnTXMz9C4lTvk7ql4m39H6UXqdcKF8SbUzI5VU0ronOI+aYmYMRglsAVGWawtXD41vrJEfonMiM3fdD9+ehR+LDcjfAuPYc/aoAbzJcxnBBkwD7YKyvPB+hrvDA=')
...
//   })
// }).catch(err => {
// this.$tipMessge.open(err.data.message)
// })
