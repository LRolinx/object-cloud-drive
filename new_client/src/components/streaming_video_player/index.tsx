...
export const StreamingVideoPlayer = defineComponent<StreamingVideoPlayerProps, StreamingVideoPlayerEmits>(
  (props, ctx) => {
    ...
    return () => {
      return (
        <>
          <Modal style="width:80vw" v-model:open={props.open} title="流视频" footer={<></>}>
            <div class="container show-controls" style={{maxWidth:'80vw',height:'60vh'}}>
              <div class="wrapper">
              ...
              <video src="/src/assets/demo-video.mp4"></video>
            </div>
          </Modal>
        </>
      )
